...
**Remarks.**
1.  In “guess-all” and “optimal-guess”, we use max(TBKZ,Tguess) instead of TBKZ + Tguess to make the algorithm easier and much quicker. This, however, may de- crease the final result by up to 1 bit.
