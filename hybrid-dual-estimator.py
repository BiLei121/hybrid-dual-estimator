...
Dilithium768={'series':'Dilithium','name':768,'parameter':{'n':768,'q':8380417,'s':3.74,'mm':1024},'distribution':{0:1/13,1:1/13,2:1/13,3:1/13,4:1/13,5:1/13,6:1/13}}
Dilithium1024={'series':'Dilithium','name':1024,'parameter':{'n':1024,'q':8380417,'s':3.16,'mm':1280},'distribution':{0:1/11,1:1/11,2:1/11,3:1/11,4:1/11,5:1/11}}
Dilithium1280={'series':'Dilithium','name':1280,'parameter':{'n':1280,'q':8380417,'s':2,'mm':1536},'distribution':{0:1/7,1:1/7,2:1/7,3:1/7}}
...
def dual_guess_estimation(instance,costmodel):
	...
	hybrid2_row=['HYBRID 2',bestb,bestr,bestm,round(bestdual,2),round(bestguess,2),round(mincost,2)]
